...
import {
  ...
  saveMedicineFormSchema,
} from '@/application/medicine/schemas/save-medicine.schema'
import { CreateMedicineService } from '@/application/medicine/service/create-medicine.service'
import { UpdateMedicineService } from '@/application/medicine/service/update-medicine.service'
...
export function SaveMedicineForm({ medicine }: SaveMedicineFormProps) {
  const { control, handleSubmit } = useForm<SaveMedicineFormSchema>({
  ...
  async function onSubmit(data: SaveMedicineFormSchema) {
    ...
    isEditPage ? updateMedicine(formattedData) : createMedicine(formattedData)
  }
